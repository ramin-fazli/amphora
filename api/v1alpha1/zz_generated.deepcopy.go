...
func (in *EvalGateSpec) DeepCopyInto(out *EvalGateSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvalGateSpec.
func (in *EvalGateSpec) DeepCopy() *EvalGateSpec {
	if in == nil {
		return nil
	}
	out := new(EvalGateSpec)
	in.DeepCopyInto(out)
	return out
}
